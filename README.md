...
* `/docs`: Contains the comprehensive Technical Architecture Report (PDF) and Presentation Deck (PPTX).
...
**IMPORTANT:** For a deep dive into the model evaluation metrics, handling of extreme class imbalances, concept drift, and the mathematical architecture, please read the `SOC_Sentinel_Technical_Report.pdf` located in the `/docs` folder.
